    ...
    namespace joint {
        ...
        public:
            ...
            void ProcessModel(const T& model,
                ...
                // utility::io::debug.out("x state update\n");
                ...
                // utility::io::debug.out("%f, %f, %f, %f, ", A_mat(1, 0), A_mat(1, 1), A_mat(1, 2), A_mat(1, 3));
            ...
            float dotV_a(float P_1, float P_2, const T& m) {
                ...
                if (P_2 / P_1 > b) {
                    return (std::isinf(P_1 * A * P_bsqrt) || std::isnan(P_1 * A * P_bsqrt)) ? 0 : P_1 * A * P_bsqrt;
                }
                return (std::isinf(P_1 * A) || std::isnan(P_1 * A)) ? 0 : P_1 * A;
            }
            ...
            float dotV_a_P_m1(float P_1, float P_2, const T& m, int mode) {
                ...
                if (mode == 2 || mode == 3) {
                    // P_2 == P_m1
                    if (P_2 / P_1 > b) {
                        return (std::isinf(-(i / (b_1 * b_1 * P_bsqrt))) || std::isnan(-(i / (b_1 * b_1 * P_bsqrt))))
                                   ? 0
                                   : -(i / (b_1 * b_1 * P_bsqrt));
                    }
                    return 0;
                    ...
                    if (P_2 / P_1 > b) {
                        return (std::isinf(A * P_bsqrt + (i * P_2 / (b_1 * b_1 * P_1 * P_bsqrt)))
                                || std::isnan(A * P_bsqrt + (i * P_2 / (b_1 * b_1 * P_1 * P_bsqrt))))
                                   ? 0
                                   : A * P_bsqrt + (i * P_2 / (b_1 * b_1 * P_1 * P_bsqrt));
                    }

                    return (std::isinf(C * std::sqrt(m.T_0 / m.T_1)) || std::isnan(C * std::sqrt(m.T_0 / m.T_1)))
                               ? 0
                               : C * std::sqrt(m.T_0 / m.T_1);
                }
                return 0;
            }
                ...
                if (mode == 1 || mode == 3) {
                    ...
                    if (P_2 / P_1 > b) {
                        ...
                        return (std::isinf(A * P_bsqrt + ((P_2 * i) / (b_1 * b_1 * P_1 * P_bsqrt)))
                                || std::isnan(A * P_bsqrt + ((P_2 * i) / (b_1 * b_1 * P_1 * P_bsqrt))))
                                   ? 0
...
// utility::io::debug.out("k1 %lf\n", k1);
// utility::io::debug.out("k2 %lf\n", k2);
// utility::io::debug.out("dotk1 %lf\n", dotk1);
// utility::io::debug.out("dotk2 %lf\n", dotk2);
                ...
                // utility::io::debug.out("dotV_a1 %lf\n", dotV_a1);
                // utility::io::debug.out("dV_m1 %lf\n", dV_m1);
                // utility::io::debug.out("P_m1 %lf\n", P_m1);
                // utility::io::debug.out("ddotV_m1_dV_m1 %lf\n", ddotV_m1_dV_m1);
                ...
                // utility::io::debug.out("\ndotV_a2 %lf\n", dotV_a2);
                // utility::io::debug.out("dV_m2 %lf\n", dV_m2);
                // utility::io::debug.out("P_m2 %lf\n", P_m2);
                // utility::io::debug.out("ddotV_m2_dV_m2 %lf\n", ddotV_m2_dV_m2);
                ...
                V_m1    = (a1 * k1 * k1 * k1) + (b1 * k1 * k1) + (c1 * k1) + d1; 
                // utility::io::debug.out("\ndotV_m1 %lf\n", dotV_m1);
                // utility::io::debug.out("V_m1 %lf\n", V_m1);
                // utility::io::debug.out("ddotV_a1 %lf\n", ddotV_a1);
                // utility::io::debug.out("ddotV_a1 * Pa %lf\n", P_a * ddotV_a1);
                float Lin_mat_2_2 = (P_a * ddotV_a1 - dotV_m1) / V_m1 + 0.34; 
                // utility::io::debug.out("Lin_mat_2_2 %lf\n", Lin_mat_2_2);
            ...
            void Compute(float theta) {
                ...
                utility::io::debug.out("Time, Setpoint, State_1, State_2, State_3, State_4, Error, Valve_1, Valve_2\n");
